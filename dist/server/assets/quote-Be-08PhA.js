...
import { C as CustomerLayout, I as Img, r as removeFromEnquiryList, c as clearEnquiryList } from "./CustomerLayout-Dmbsnk0W.js";
...
import { c as categoryToServiceOptions } from "./site-Csrvuq7G.js";
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, noValidate: true, className: "space-y-8", children: [
      ...
      /* @__PURE__ */ jsxs("section", { "aria-labelledby": "sec-event", className: "rounded-xl border border-ink-200 bg-white p-5 shadow-sm sm:p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsx(Field, { label: "Event location (optional)", htmlFor: "q-location", children: /* @__PURE__ */ jsx(Input, { id: "q-location", value: form.location, onChange: (e) => set("location")(e.target.value), placeholder: "e.g. Port Elizabeth, Eastern Cape" }) })
        ] })
      ] }),
