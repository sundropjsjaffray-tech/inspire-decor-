...
import { d as getContactDetails } from "./content-L4BOmwm4.js";
import { a as sendContactMessageNotification } from "./notifications-DDqnCVsC.js";
  ...
  return /* @__PURE__ */ jsxs(CustomerLayout, { children: [
    ...
    !details ? /* @__PURE__ */ jsx(LoadingState, { label: "Loading contact details…" }) : /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-5 lg:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { role: "img", "aria-label": "Service area map placeholder — Port Elizabeth, Eastern Cape", className: "flex min-h-40 flex-col items-center justify-center rounded-xl border border-dashed border-gold-300 bg-gradient-to-br from-champagne-200 via-champagne-100 to-gold-200 p-6 text-center", children: [
          /* @__PURE__ */ jsx("span", { "aria-hidden": "true", className: "text-2xl text-gold-600", children: "📍" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 font-display text-lg font-semibold text-ink-900", children: "Port Elizabeth, Eastern Cape" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-ink-500", children: "Map coming soon — we currently deliver across Port Elizabeth, Eastern Cape." })
        ] })
      ] }),
